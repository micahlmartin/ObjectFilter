...
$script:packit.default_package = "ObjectFilter"
...
$script:packit.release_notes = "Fixed a number of bugs"
...
$script:packit.package_tags = "filtering tools api utilities"
$script:packit.package_version = "0.0.1.1"
$script:packit.package_iconUrl = "https://github.com/micahlmartin/ObjectFilter"
...
$script:packit.versionAssemblyName = $script:packit.binaries_Location + "\ObjectFilter.dll"
